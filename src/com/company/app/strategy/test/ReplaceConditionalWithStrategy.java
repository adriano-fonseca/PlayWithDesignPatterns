package com.company.app.strategy.test;
...
public class ReplaceConditionalWithStrategy {
  ...
  public static void main(String[] args) {
    ...
    //The default behavior is don't have a bonus.
    ...
    salesman.setBonusOption(new BonusDefault());
...
class BonusDefault implements Pay {
